    ...
    render() {
        return (
            <div>
                ...
                <img src='https://p.kindpng.com/picc/s/52-520112_download-philosophy-clipart-stichting-sportraad-sliedrecht-grey-right.png' alt='placeHolder' className="mapImage" />
                <Footer />
            </div>
        )
    }
